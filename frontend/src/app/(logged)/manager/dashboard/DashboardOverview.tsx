  ...
  return (
    <div className="dashboard-overview space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Fatores de Risco */}
        <Card className="risk-chart">
          <CardHeader>
            <CardTitle>Fatores de Risco</CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-muted-foreground text-sm mb-4">
              Principais fatores psicossociais identificados
            </p>
            <div className="flex items-end justify-between h-56 w-full gap-4">
              {[
                ...
                >
                  ...
                  <span className="mt-2 text-xs text-center text-foreground break-words">
                    {item.label}
                  </span>
                </div>
              ))}
        ...
        <Card className="productivity-chart">
          ...
          <CardContent>
            <p className="text-muted-foreground text-sm mb-4">
              Produtividade dos departamentos no último mês
            </p>
            {[
              { label: "RH", value: 78 },
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-4 p-4 bg-muted rounded-lg">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Ações corretivas para tratar fatores de risco identificados e
            ...
            <div className="flex items-start gap-4 p-4 bg-muted rounded-lg">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Medidas para evitar o surgimento de novos riscos
                  psicossociais e promover a saúde mental.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 p-4 bg-muted rounded-lg">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Estratégias para lidar rapidamente com situações críticas e
